...
/**
 * Disposable Email Checker Class
 *
 * File: includes/disposable-email-checker.php
 * Contains 500+ known disposable/temporary email domains
 */
...
class SpamDetective_DisposableEmailChecker
{
  /**
   * List of known disposable email domains
   * Comprehensive list of temporary/throwaway email services
   */
   ...
   *
   * @param string $email Full email address or domain
  ...
  /**
   * Get risk score for disposable email
   *
   * @param string $email Full email address
   * @return int Risk score (0 if not disposable, 40 if disposable)
   */
  public static function get_risk_score($email)
  {
    return self::is_disposable($email) ? 40 : 0;
  }

  /**
   * Get the list of disposable domains (for export/admin purposes)
   *
   * @return array List of disposable domains
   */
  public static function get_disposable_domains()
  {
